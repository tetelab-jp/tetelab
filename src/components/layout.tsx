...
const NAV_ITEMS: {
  ...
  { key: 'style-import', href: '/style/import', icon: 'fa-cloud-arrow-down', label: 'HPBからスタイル追加', group: 'style' },
  { key: 'style-template', href: '/style/template', icon: 'fa-sliders', label: 'スタイル一括修正', group: 'style' },
  ...
  { key: 'blog-template', href: '/blog/template', icon: 'fa-wand-magic-sparkles', label: '記事テンプレート作成', group: 'blog' },
  ...
  { key: 'review-replied', href: '/reviews/replied', icon: 'fa-comment-dots', label: '返信済み口コミ', group: 'review' },
  ...
  { key: 'review-settings', href: '/reviews/settings', icon: 'fa-sliders', label: '口コミ設定', group: 'review' },
