...
const NAV_ITEMS: {
  ...
  { key: 'style-import', href: '/style/import', icon: 'fa-cloud-arrow-down', label: 'HPBからスタイル取込', group: 'style' },
  ...
  { key: 'blog-salon', href: '/blog/salon', icon: 'fa-shop', label: 'HPBからブログ取込', group: 'blog' },
