...
export default defineConfig({
  plugins: [
    build({
      ...
      external: ['pg', 'pg-native', 'puppeteer', 'puppeteer-extra', 'puppeteer-extra-plugin-stealth', '@aws-sdk/client-s3', '@aws-sdk/client-ecs', '@aws-sdk/credential-provider-http', '@hono/node-server', '@hono/node-server/serve-static', 'undici']
    }),
    devServer({
      entry: 'src/index.tsx'
    })
